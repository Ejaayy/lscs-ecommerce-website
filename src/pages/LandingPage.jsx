export default function LandingPage() {
  return (
    <div className="relative bg-neutral">
      ...
      {/* Hero Section */}
      <section 
        className="relative pt-44 pb-20 text-center bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        <div className="relative z-10">
          ...
          {/* Tagline */}
          <p className="text-sm uppercase tracking-wider text-white text-shadow-xl-small mb-4">
            Smarter Shopping, Simplified
          </p>

          {/* Main Heading */}
        <h2 className="text-5xl font-extrabold mb-6">
          <span className="text-white heading-shadow-2xl">
            Welcome to
          </span>{" "}
          <span className="text-accent heading-shadow-2xl">
            TindaHub
          </span>
        </h2>

          {/* Subtext */}
          <p className="text-lg text-white max-w-2xl mx-auto mb-8 text-shadow-xl-small">
            Discover products, compare prices, and shop smarter with our all-in-one platform.
          </p>

          {/* Primary Actions */}
          <div className="flex flex-wrap justify-center gap-4 mb-6 text-shadow-xl-small">
            <a
              href="#get-started"
          ...
          {/* Secondary Actions */}
          <div className="flex flex-wrap justify-center gap-6 text-sm font-medium text-white text-shadow-xl-small">
